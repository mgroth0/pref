...
import matt.model.code.errreport.common.printReport
...
open class PrefNode(
    ...
    inner class ObsObjPref<T : Any>(
        ...
        fun getFromNode() =
            try {
                val strOrNull =  prefs.get(name, null)
                strOrNull?.let { json.decodeFromString(ser, it) }
